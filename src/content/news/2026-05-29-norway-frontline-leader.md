---
title: "Norway leads the board - while sharing a border with a country at war"
description: "Norway ranks #1 for living and #2 for assets and currency, with a 198 km Russian border and a NATO front line on its territory. How a frontline-adjacent state still tops the table: the difference between a category and the composite, and between level and skew."
...
- **Institutional 8.4** - among the highest on the entire board: rule of law,
...
See the [Norway assessment](/ratings/nor/) and [compare it with Switzerland and
Luxembourg](/ratings/compare/), the two states closest behind it.
