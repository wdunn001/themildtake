...
Projected across the horizon, the two converge downward: China starts higher in
the near term but slides toward the US's level, while the US stays pinned near the
bottom — two negative slopes meeting in the same neighborhood.

<CountryTrajectory
  countries="usa,chn"
  decision="living"
  caption="Living score projected near → long: China starts higher but slides toward the US's level; the US stays pinned near the bottom."
  client:visible
/>
